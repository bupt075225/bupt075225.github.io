MIT App Inventor是一个云端Android App开发软件，通过google账号从浏览器[登录](http://ai2.appinventor.mit.edu/)后进行APP开发。开发界面有Designer和Blocks，前者用于设计用户界面组件，后者用于为组件设定程序逻辑及事件行为，如下图所示：
